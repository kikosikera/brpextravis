---
title: "brpextravis: read and summarize FARS data"
author: "San Budiman"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{brpextravis: read and summarize FARS data}
...
4. **fars_summarize_years** that takes a vector of integer years as input and returns a summarized data frame containing the number of incidents for every month & year. Years are represented in the columns and months are represented in the rows
