---
title: "Introduction to brpextravis package for reading and summarizing FARS data"
author: "San Budiman"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{brpextravisintro}
...
Raw Data are read using 'fars_read', and the filename construction can be facilitated by 'make_filename'.
Example:
```{r sample2013_data}
filename <- make_filename(2013)
fars_2013 <- fars_read(file.path("..","extdata",filename)) 
dim(fars_2013)
fars_2013
```
